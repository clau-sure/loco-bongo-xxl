  ...
  const enterNumber = () => {
    ...
    if (inputValue > 0 && inputValue <= 90) {
      ...
      if (
        ...
        classList.contains("lastSelected")
      ) {
      ...
      if (
        prevNumber &&
        document.getElementById(prevNumber).classList.contains("lastSelected")
      ) {
      ...
      <div className="all">
        ...
        <div className="both">
          <div className="wrapper">
            <div className="first_row">{numbers(1, 10)}</div>
            <div className="first_row">{numbers(11, 20)}</div>
            <div className="first_row">{numbers(21, 30)}</div>
            <div className="first_row">{numbers(31, 40)}</div>
            <div className="first_row">{numbers(41, 50)}</div>
            <div className="first_row">{numbers(51, 60)}</div>
            <div className="first_row">{numbers(61, 70)}</div>
            <div className="first_row">{numbers(71, 80)}</div>
            <div className="last_row">{numbers(81, 90)}</div>
          </div>
